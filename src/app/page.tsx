  ...
  return (
    <div>
      <main className='flex flex-col justify-center items-center pt-12 lg:px-36 md:px-14 px-5 text-center'>
          ...
          <div className='mt-6 flex gap-1 bg-linear-to-r from-[#8664FF0D] to-[#F5C96C0D] py-2 px-4 text-left border border-[#D9B48F33] rounded-2xl lg:mx-80 md:mx-42'>
            <div className='w-1/3'>
          ...
          <div className='flex flex-col md:flex-row gap-4 mt-12'>
            <div className='border border-[#F0F2F4] p-3 px-5 text-[14px] flex flex-col justify-center items-center md:w-1/3 lg:w-72 h-56 rounded-3xl'>
                ...
                <div>
                  <h2 className='font-medium text-[20px]'>Beautiful Banners</h2>
            ...
            <div className='border border-[#F0F2F4] p-3 px-5 text-[14px] flex flex-col justify-center items-center md:w-1/3 lg:w-72 h-56 rounded-3xl'>
                ...
                <div>
                  <h2 className='font-medium text-[20px]'>GDPR & CCPA Ready</h2>
            ...
            <div className='border border-[#F0F2F4] p-3 px-5 text-[14px] flex flex-col justify-center items-center md:w-1/3 lg:w-72 h-56 rounded-3xl'>
                ...
                <div>
                  <h2 className='font-medium text-[20px]'>One Line Setup</h2>
